...
extern DWORD gDeltaTime; // アニメーション関係で使う
...
void Model::AnimationUpdate(int setState, int* setFlame)
{
	// アニメーションの時間をカウント
...
void Model::SetUVAnimation(int mState, int idxNowFlame)
{
	...
	else
	{
		...
		float frameYoko = (float)idxNowFlame; // テーブルから現在のコマを取得
