...
// 2D用のポリゴン作成をし，テクスチャを読み込む
// 引数
// 1.横幅 2.縦幅 3.uvの縦幅 4.uvの横幅 5.テクスチャファイル名
ModelData myPolygon::CreateSquarePolygon(float width, float height, float uvWidth, float uvHeight, const wchar_t* texFile)
{
	{
		// モデル頂点データ作成
